...
\begin{document}	
	...
	\begin{tikzpicture}
		...
		\begin{axis}[
			...
			\addplot[color=red, mark=*] table[x index=0, y index=1] {Std.dat}; 
			\addplot[color=blue, mark=*] table[x index=0, y index=1] {Vin.dat};
			\addplot[color=green, mark=*] table[x index=0, y index=1] {VinMod.dat};
			
			\addlegendentry{Std}
			\addlegendentry{Vin}
			\addlegendentry{VinMod}
	...
	\begin{tikzpicture}
		...
		\begin{axis}[
			...
			\addplot[color=red, mark=*] table[x index=0, y index=1] {Std2.dat}; 
			\addplot[color=blue, mark=*] table[x index=0, y index=1] {Vin2.dat};
			\addplot[color=green, mark=*] table[x index=0, y index=1] {VinMod2.dat};
